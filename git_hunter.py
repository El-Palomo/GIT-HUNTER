...
def get_string(enterprise,directory):
    ...
    lista = [";pass","storePassword","jdbc","DatabaseName",".password=","datasource.password","datasource.username","password=","Data Source=","Data Source =","password =","<password>","_password"]
    for i in lista:
